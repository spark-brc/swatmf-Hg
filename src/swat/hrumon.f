...
!!    lat q continuous
        ...
        pdvas(80) = hrumono(73,j)
        pdvas(81) = hrumono(74,j)
        pdvas(82) = hrumono(75,j)
        pdvas(83) = hrumono(76,j)
        pdvas(84) = hrumono(77,j)
        pdvas(85) = hrumono(78,j)
        pdvas(86) = hrumono(79,j)
        pdvas(87) = hrumono(80,j)
        pdvas(88) = hrumono(81,j)
        pdvas(89) = hrumono(82,j)
        pdvas(90) = hrumono(83,j) / Real(days)
        pdvas(91) = hrumono(84,j) / Real(days)
        pdvas(92) = hrumono(85,j) / Real(days)
        pdvas(93) = hrumono(86,j) / Real(days)
        pdvas(94) = hrumono(87,j) / Real(days)
        pdvas(95) = hrumono(88,j) / Real(days)
        pdvas(96) = hrumono(89,j) / Real(days)
        pdvas(97) = hrumono(90,j) / Real(days)
        pdvas(98) = hrumono(91,j) / Real(days)
        pdvas(99) = hrumono(92,j) / Real(days)
        pdvas(100) = hrumono(93,j) / Real(days)
        pdvas(101) = hrumono(94,j) / Real(days)
        pdvas(102) = hrumono(95,j) / Real(days)
        pdvas(103) = hrumono(96,j) / Real(days)
        pdvas(104) = hrumono(97,j) / Real(days)
        pdvas(105) = hrumono(98,j)
        pdvas(106) = hrumono(99,j)
        pdvas(107) = hrumono(100,j)
        pdvas(108) = hrumono(101,j)
        pdvas(109) = hrumono(102,j)
        pdvas(110) = hrumono(103,j)
        pdvas(111) = hrumono(104,j)
        pdvas(112) = hrumono(105,j)
        pdvas(113) = hrumono(106,j)
        pdvas(114) = hrumono(107,j)
        pdvas(115) = hrumono(108,j)
        pdvas(116) = hrumono(109,j)
        pdvas(117) = hrumono(110,j)
        pdvas(118) = hrumono(111,j)
        pdvas(119) = hrumono(112,j)
        pdvas(120) = hrumono(113,j) / Real(days)
        pdvas(121) = hrumono(114,j)
        pdvas(122) = hrumono(115,j)
        pdvas(123) = hrumono(116,j)
        pdvas(124) = hrumono(117,j)
     ...
     &         iyr, mo_chk,0, hru_km(j), (pdvs(ii), ii = 1, 79)
            write (7746000,1000) cropname, j, subnum(j), hruno(j), sb,       
     &         iyr, mo_chk,0, hru_km(j), (pdvs(ii), ii = 80, ix)
            case (1)
     ...
     &         nmgt(j), mo_chk, hru_km(j),(pdvs(ii), ii = 1, 79)
            write (7746000,2000) cropname, j, subnum(j), hruno(j), sb,       
     &         nmgt(j), mo_chk, hru_km(j),(pdvs(ii), ii = 80, ix)
            end select
          end if
 1000 format (a4,i5,1x,a5,a4,i5,1x,i4,1x,i3,1x,i3,1x,e10.5,119E12.3)
 2000 format (a4,i5,1x,a5,a4,i5,1x,i4,1x,i4,e10.5,119E12.3,i5)
!     else
