...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
 ...
 !! added NO3 Concentration to output.rch (for daily only) gsm 10/26/2011
        ...
        !! Mercury Jaehak 2017
        pdvar(47) = rchmono(47,j)  !dissolved Hg0 mg  
        pdvar(48) = rchmono(48,j)  !dissolved Hg2+ mg  
        pdvar(49) = rchmono(49,j)  !dissolved MeHg mg  
        pdvar(50) = rchmono(50,j)  !particulate Hg0 mg 
        pdvar(51) = rchmono(51,j)  !particulate Hg2+ mg 
        pdvar(52) = rchmono(52,j)  !particulate MeHg mg  
        pdvar(53) = rchmono(53,j)     !inflow dissolved Hg0 mg  
        pdvar(54) = rchmono(54,j)     !inflow dissolved Hg2+ mg  
        pdvar(55) = rchmono(55,j)     !inflow dissolved MeHg mg  
        pdvar(56) = rchmono(56,j)     !inflow particulate Hg0 mg 
        pdvar(57) = rchmono(57,j)     !inflow particulate Hg2+ mg 
        pdvar(58) = rchmono(58,j)     !inflow particulate MeHg mg 
        pdvar(59) = rchmono(59,j)/ Real(mdays)     !channel stored dissolved Hg0 mg    
        pdvar(60) = rchmono(60,j)/ Real(mdays)     !channel stored dissolved Hg2+ mg     
        pdvar(61) = rchmono(61,j)/ Real(mdays)     !channel stored dissolved MeHg mg      
        pdvar(62) = rchmono(62,j)/ Real(mdays)     !channel stored particulate Hg0 mg     
        pdvar(63) = rchmono(63,j)/ Real(mdays)     !channel stored particulate Hg2+ mg    
        pdvar(64) = rchmono(64,j)/ Real(mdays)     !channel stored particulate MeHg mg     
     ...
     &                                    (pdvr(ii), ii = 1, 46)
          write (7746001,5000) j, subgis(j), mo_chk,rch_dakm(j),pdvr(2),           
     &                                    (pdvr(ii), ii = 47, itotr)
     ...
     &                              (pdvr(ii), ii = 1, 46)  
          write (7746001,6000) j, subgis(j), mo_chk,rch_dakm(j),pdvr(2),             
     &                              (pdvr(ii), ii = 47, itotr)  
          endif
        else
