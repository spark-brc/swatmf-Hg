...
!!      latq contribution
        ...
        pdvas(80) = hruaao(73,j)
        pdvas(81) = hruaao(74,j)
        pdvas(82) = hruaao(75,j)
        pdvas(83) = hruaao(76,j)
        pdvas(84) = hruaao(77,j)
        pdvas(85) = hruaao(78,j)
        pdvas(86) = hruaao(79,j)
        pdvas(87) = hruaao(80,j)
        pdvas(88) = hruaao(81,j)
        pdvas(89) = hruaao(82,j)
        pdvas(90) = hruaao(83,j) / Real(366 - leapyr)
        pdvas(91) = hruaao(84,j) / Real(366 - leapyr)
        pdvas(92) = hruaao(85,j) / Real(366 - leapyr)
        pdvas(93) = hruaao(86,j) / Real(366 - leapyr)
        pdvas(94) = hruaao(87,j) / Real(366 - leapyr)
        pdvas(95) = hruaao(88,j) / Real(366 - leapyr)
        pdvas(96) = hruaao(89,j) / Real(366 - leapyr)
        pdvas(97) = hruaao(90,j) / Real(366 - leapyr)
        pdvas(98) = hruaao(91,j) / Real(366 - leapyr)
        pdvas(99) = hruaao(92,j) / Real(366 - leapyr)
        pdvas(100) = hruaao(93,j) / Real(366 - leapyr)
        pdvas(101) = hruaao(94,j) / Real(366 - leapyr)
        pdvas(102) = hruaao(95,j) / Real(366 - leapyr)
        pdvas(103) = hruaao(96,j) / Real(366 - leapyr)
        pdvas(104) = hruaao(97,j) / Real(366 - leapyr)
        pdvas(105) = hruaao(98,j)
        pdvas(106) = hruaao(99,j)
        pdvas(107) = hruaao(100,j)
        pdvas(108) = hruaao(101,j)
        pdvas(109) = hruaao(102,j)
        pdvas(110) = hruaao(103,j)
        pdvas(111) = hruaao(104,j)
        pdvas(112) = hruaao(105,j)
        pdvas(113) = hruaao(106,j)
        pdvas(114) = hruaao(107,j)
        pdvas(115) = hruaao(108,j)
        pdvas(116) = hruaao(109,j)
        pdvas(117) = hruaao(110,j)
        pdvas(118) = hruaao(111,j)
        pdvas(119) = hruaao(112,j)
        pdvas(120) = hruaao(113,j) / Real(366 - leapyr)
        pdvas(121) = hruaao(114,j)
        pdvas(122) = hruaao(115,j)
        pdvas(123) = hruaao(116,j)
 ...
 1000 format (a4,i5,1x,a5,a4,i5,1x,f4.1,1x,i3,1x,i3,1x,e10.5,119E12.3)

          if (iscen == 1 .and. isproj == 0) then
          write (28,1000) cropname, j, subnum(j), hruno(j), sb,         
     &        years, 0,0, hru_km(j), (pdvs(ii), ii = 1, 79)
          write (7746000,1000) cropname, j, subnum(j), hruno(j), sb,         
     &        years, 0,0, hru_km(j), (pdvs(ii), ii = 80, itots)
     ...
     &    nmgt(j), years, hru_km(j), (pdvs(ii), ii = 1, 79)
           write (7746000,2000) cropname, j, subnum(j), hruno(j), sb,         
     &    nmgt(j), years, hru_km(j), (pdvs(ii), ii = 80, itots)
         endif
        else
          if (iscen == 1 .and. isproj == 0) then
          write (28,1001) cropname, j, subnum(j), hruno(j), sb,         
     &            nmgt(j), years, hru_km(j), (pdvas(ii), ii = 1, 79)
          write (7746000,1001) cropname, j, subnum(j), hruno(j), sb,         
     &            nmgt(j), years, hru_km(j), (pdvas(ii), ii = 80, mhruo)
          else if (isproj == 1) then
