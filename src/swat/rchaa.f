...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
 ...
 !! added NO3 Concentration to output.rch (for daily only) gsm 10/26/2011
        ...
        pdvar(47) = rchaao(47,j)     !!Hg0D mg  Mercury Jaehak 2017
        pdvar(48) = rchaao(48,j)     !!Hg2D mg 
        pdvar(49) = rchaao(49,j)     !!MeHgD mg
        pdvar(50) = rchaao(50,j)     !!Hg0P mg 
        pdvar(51) = rchaao(51,j)     !!Hg2P mg 
        pdvar(52) = rchaao(52,j)     !!MeHgP mg
        pdvar(53) = rchaao(53,j)     !inflow dissolved Hg0 mg  
        pdvar(54) = rchaao(54,j)     !inflow dissolved Hg2+ mg  
        pdvar(55) = rchaao(55,j)     !inflow dissolved MeHg mg  
        pdvar(56) = rchaao(56,j)     !inflow particulate Hg0 mg 
        pdvar(57) = rchaao(57,j)     !inflow particulate Hg2+ mg 
        pdvar(58) = rchaao(58,j)     !inflow particulate MeHg mg 
        pdvar(59) = rchaao(59,j)     !channel stored dissolved Hg0 mg    
        pdvar(60) = rchaao(60,j)     !channel stored dissolved Hg2+ mg     
        pdvar(61) = rchaao(61,j)     !channel stored dissolved MeHg mg      
        pdvar(62) = rchaao(62,j)     !channel stored particulate Hg0 mg     
        pdvar(63) = rchaao(63,j)     !channel stored particulate Hg2+ mg    
        pdvar(64) = rchaao(64,j)     !channel stored particulate MeHg mg     
     ...
     &                                    (pdvr(ii), ii = 1, 46)
          write (7746001,5000) j, subgis(j), years, rch_dakm(j),pdvr(2),              
     &                                    (pdvr(ii), ii = 47, itotr)
     ...
     &                             (pdvr(ii), ii = 1, 46)  
          write (7746001,6000) j, subgis(j), years, rch_dakm(j),pdvr(2),              
     &                             (pdvr(ii), ii = 47, itotr)  
          endif
        else
!!  increase to 44 in loops below from 42 gsm 10/17/2011
     ...
     &                             (pdvar(ii), ii = 47, itotr)      
      ...
      return
 5000 format ('REACH ',i4,1x,i8,1x,f5.1,100e12.4)
 6000 format ('REACH ',i4,1x,i8,1x,f5.1,100e12.4)
      end