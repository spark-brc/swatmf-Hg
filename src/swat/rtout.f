...
!! set daily reach output
      ...
      rchdy(4,jrch) = rttlc(jrch) / 86400.                     !!tloss (m^3/s)
...
!Mercury
       rchdy(47,jrch) = varoute(46,ihout)                   !outflow dissolved Hg0 mg  
       rchdy(48,jrch) = varoute(47,ihout)                   !outflow dissolved Hg2+ mg  
       rchdy(49,jrch) = varoute(48,ihout)                   !outflow dissolved MeHg mg  
       rchdy(50,jrch) = varoute(43,ihout)                   !outflow particulate Hg0 mg 
       rchdy(51,jrch) = varoute(44,ihout)                   !outflow particulate Hg2+ mg 
       rchdy(52,jrch) = varoute(45,ihout)                   !outflow particulate MeHg mg  

       rchdy(53,jrch) = varoute(46,inum2) * (1. - rnum1)    !inflow dissolved Hg0 mg  
       rchdy(54,jrch) = varoute(47,inum2) * (1. - rnum1)    !inflow dissolved Hg2+ mg  
       rchdy(55,jrch) = varoute(48,inum2) * (1. - rnum1)    !inflow dissolved MeHg mg  
       rchdy(56,jrch) = varoute(43,inum2) * (1. - rnum1)    !inflow particulate Hg0 mg 
       rchdy(57,jrch) = varoute(44,inum2) * (1. - rnum1)    !inflow particulate Hg2+ mg 
       rchdy(58,jrch) = varoute(45,inum2) * (1. - rnum1)    !inflow particulate MeHg mg 
       rchdy(59,jrch) = sum(Hg_chstor(:,:,jrch,1))               !channel stored THg mg      
       rchdy(60,jrch) = sum(Hg_chstor(:,3,jrch,1))               !channel stored MeHg+ mg      
       rchdy(61,jrch) = sum(Hg_chstor(:,:,jrch,2))               !sedlayer1 stored THg mg      
       rchdy(62,jrch) = sum(Hg_chstor(:,3,jrch,2))               !sedlayer1 stored MeHg+ mg      
       rchdy(63,jrch) = Hg_chstor(1,1,jrch,3)               !THg in water ppb      
       rchdy(64,jrch) = hg_sedcon             !channel sediment THg, mg/kg      
       end if
	!if(jrch==11) write(*,*)rchdy(64,jrch)
...
!! Mercury
       rchmono(47,jrch) = rchmono(47,jrch) + rchdy(47,jrch)
       rchmono(48,jrch) = rchmono(48,jrch) + rchdy(48,jrch)
       rchmono(49,jrch) = rchmono(49,jrch) + rchdy(49,jrch)
       rchmono(50,jrch) = rchmono(50,jrch) + rchdy(50,jrch)
       rchmono(51,jrch) = rchmono(51,jrch) + rchdy(51,jrch)
       rchmono(52,jrch) = rchmono(52,jrch) + rchdy(52,jrch)
