...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
	...
	!conc_hg=(/10,10,12,12,33,27,40,43,78,77,110,73,79,60,50/)
	!!conc_hg=conc_hg*eros_spl
	!do jrch=1,nrch
	!	
	!ch_a=ch_w(2,jrch)*ch_l2(jrch)*1000. !m2
 !     Hg_chstor(2,2,jrch,2)=10.*1.3*conc_hg(jrch)*ch_a*20.  !sediment Hg, mg, 20cm thickness
 !
	!enddo
      !!initialize variables at beginning of day
      deg_z=0
	dep_z=0. !Hg sediment loss for the day
	cbodu = 0.
      chl_a = 0.
      cnday = 0.
      dayl = 0.
