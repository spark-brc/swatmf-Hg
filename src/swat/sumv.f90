...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      !! HRU summations
        ...
        !Mercury output, Jaehak Jeong 2017
        hrumono(73,j) = hrumono(73,j) + Hg_dry_total(1,2,j) !total dissolved Hg2 dry deposition (mg/ha)
        hrumono(74,j) = hrumono(74,j) + Hg_dry_total(2,2,j) !total particulate Hg2+ dry deposition (mg/ha)
        hrumono(75,j) = hrumono(75,j) + Hg_dry_leaf(1,2,j) !leaf dissolved Hg2 dry deposition (mg/ha)
        hrumono(76,j) = hrumono(76,j) + Hg_dry_leaf(2,2,j) !land particulate Hg2+ dry deposition (mg/ha)
        hrumono(77,j) = hrumono(77,j) + Hg_wet_total(1,2,j) !! total dissolved Hg2+ wet deposition, mg/ha
        hrumono(78,j) = hrumono(78,j) + Hg_wet_direct(1,2,j) !! direct land dissolved Hg2+ wet deposition, mg/ha
        hrumono(79,j) = hrumono(79,j) + Hg_wet_thru(1,2,j) ! throughfall dissolved Hg2+ wet deposition, mg/ha
        hrumono(80,j) = hrumono(80,j) + Hg_leaf_fall(1,1,j) !leaf fall of dissolved Hg0 (mg/ha)
        hrumono(81,j) = hrumono(81,j) + Hg_leaf_fall(1,2,j) !leaf fall of dissolved Hg2+ (mg/ha)
        hrumono(82,j) = hrumono(82,j) + Hg_leaf_fall(2,2,j) !leaf fall of particulate Hg2+ (mg/ha)
        hrumono(83,j) = hrumono(83,j) + Hg_leaf(1,1,j,1)+Hg_leaf(1,1,j,2) !leaf storage of dissolved Hg0 (mg/ha)
        hrumono(84,j) = hrumono(84,j) + Hg_leaf(1,2,j,1)+Hg_leaf(1,2,j,2) !leaf storage of dissolved Hg+ (mg/ha)
        hrumono(85,j) = hrumono(85,j) + Hg_leaf(2,2,j,1)+Hg_leaf(2,2,j,2) !leaf storage of particulate Hg2+ (mg/ha)
        hrumono(86,j) = hrumono(86,j) + Hg_residue(1,1,j) !residue storage of dissolved Hg0 (mg/ha)
        hrumono(87,j) = hrumono(87,j) + Hg_residue(1,2,j) !residue storage of dissolved Hg2+ (mg/ha)
        hrumono(88,j) = hrumono(88,j) + Hg_residue(2,2,j) !residue storage of particulate Hg2+ (mg/ha)
        hrumono(89,j) = hrumono(89,j) + Hg_soil(1,1,j) !soil storage of dissolved Hg0 (mg/ha)
        hrumono(90,j) = hrumono(90,j) + Hg_soil(1,2,j) !soil storage of dissolved Hg2+ (mg/ha)
        hrumono(91,j) = hrumono(91,j) + Hg_soil(1,3,j) !soil storage of dissolved MeHg (mg/ha)
        hrumono(92,j) = hrumono(92,j) + Hg_soil(2,1,j) !soil storage of particulate Hg0 (mg/ha)
        hrumono(93,j) = hrumono(93,j) + Hg_soil(2,2,j) !soil storage of particulate Hg2+ (mg/ha)
        hrumono(94,j) = hrumono(94,j) + Hg_soil(2,3,j) !soil storage of particulate MeHg (mg/ha)
        hrumono(95,j) = hrumono(95,j) + Hg_shallst(1,1,j) !shallow aquifer storage of dissolved Hg0 (mg/ha)
        hrumono(96,j) = hrumono(96,j) + Hg_shallst(1,2,j) !shallow aquifer storage of dissolved Hg2+ (mg/ha)
        hrumono(97,j) = hrumono(97,j) + Hg_shallst(1,3,j) !shallow aquifer storage of dissolved MeHg (mg/ha)
        hrumono(98,j) = hrumono(98,j) + Hg_surq(1,j) !dissolved Hg0 in runoff (mg/ha)
        hrumono(99,j) = hrumono(99,j) + Hg_surq(2,j) !dissolved Hg2+ in runoff (mg/ha)
        hrumono(100,j) = hrumono(100,j) + Hg_surq(3,j) !dissolved MeHg in runoff (mg/ha)
        hrumono(101,j) = hrumono(101,j) + Hg_latq(1,j) !dissolved Hg0 in lateral flow (mg/ha)
        hrumono(102,j) = hrumono(102,j) + Hg_latq(2,j) !dissolved Hg2+ in lateral flow (mg/ha)
        hrumono(103,j) = hrumono(103,j) + Hg_latq(3,j) !dissolved MeHg in lateral flow (mg/ha)
        hrumono(104,j) = hrumono(104,j) + Hg_perc(1,j) !dissolved Hg0 percolated to shallow aquifer (mg/ha)
        hrumono(105,j) = hrumono(105,j) + Hg_perc(2,j) !dissolved Hg2+ percolated to shallow aquifer (mg/ha)
        hrumono(106,j) = hrumono(106,j) + Hg_perc(3,j) !dissolved MeHg percolated to shallow aquifer (mg/ha)
        hrumono(107,j) = hrumono(107,j) + Hg_gwq(1,j) !dissolved Hg0 in groundwater return flow (mg/ha)
        hrumono(108,j) = hrumono(108,j) + Hg_gwq(2,j) !dissolved Hg2+ in groundwater return flow (mg/ha)
        hrumono(109,j) = hrumono(109,j) + Hg_gwq(3,j) !dissolved MeHg in groundwater return flow (mg/ha)
        hrumono(110,j) = hrumono(110,j) + Hg_sedyld(1,j) !particulate Hg0 in sediment yield (mg/ha)
        hrumono(111,j) = hrumono(111,j) + Hg_sedyld(2,j) !particulate Hg2+ in sediment yield (mg/ha)
        hrumono(112,j) = hrumono(112,j) + Hg_sedyld(3,j) !particulate MeHg in sediment yield (mg/ha)
        hrumono(113,j) = hrumono(113,j) + Hg_sc(j) !total Hg concentration in soil (ng/kg)
        hrumono(114,j) = hrumono(114,j) + Hg_wyld(1,j) !Hg0 in water yield (mg/ha)
        hrumono(115,j) = hrumono(115,j) + Hg_wyld(2,j) !Hg2 in water yield  (mg/ha)
        hrumono(116,j) = hrumono(116,j) + Hg_wyld(3,j) !MeHg in water yield  (mg/ha)
        hrumono(117,j) = hrumono(117,j) + Hg0_vola(j) !Hg volatilization from soil to atmosphere (mg/ha)
