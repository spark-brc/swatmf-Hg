...
!!    Spatial Sciences Laboratory, Texas A&M University
	  ...
	  if (jrch==11) then
		  rchstor(jrch) = rchstor(jrch) + 497. + RILL_MULT*wtrin !treated leachate from WWTP, m3/d
	  endif
	  if (jrch==6)  rchstor(jrch) = rchstor(jrch) + 597. !m3/d
	  if (jrch==15)  rchstor(jrch) = rchstor(jrch) + 200. !m3/d
	  if (jrch==9)  rchstor(jrch) = rchstor(jrch) + 162. !m3/d
	  if (jrch==4)  rchstor(jrch) = rchstor(jrch) + 30. !m3/d
